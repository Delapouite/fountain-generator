  ...
  fountainPrompting() {
    ...
    const prompts = [{
      ...
      choices: [
        ...
        {name: 'Vue 2', value: 'vue', disabled: 'Planned. Contributors welcome.'},
        {name: 'Ember 2', value: 'ember', disabled: 'Planned. Contributors welcome.'},
        {name: 'Backbone', value: 'backbone', disabled: 'Planned. Contributors welcome.'}
      ]
    }, {
      ...
      choices(responses) {
        const choices = [
          ...
          {name: 'Browserify', value: 'browserify', disabled: 'Planned. Contributors welcome.'}
        ];
      ...
      choices: [
        ...
        {name: 'CSSNext', value: 'cssnext', disabled: 'Planned. Contributors welcome.'},
        {name: 'Stylus', value: 'stylus', disabled: 'Planned. Contributors welcome.'},
